...
{
       0,   147,   147,   148,   150,   150,   150,   150,   154,   157,
     158,   159,   160,   161,   162,   163,   164,   165,   166,   167,
     168,   169,   171,   172,   173,   174,   177,   178,   188,   189,
     192,   193,   198,   200,   202,   203,   204,   205,   206,   207,
     208,   209,   210,   211,   212,   213,   214,   215,   218,   219,
     220,   221,   224,   225,   235,   236,   239,   240,   245,   246,
     249,   251,   252,   253,   254,   255,   256,   257,   258,   259,
     260,   261,   262,   263,   264,   267,   268,   269,   270,   273,
     274,   284,   285,   288,   289,   294,   295,   298,   307,   308,
     309,   310,   311,   312,   313,   314,   315,   316,   317,   318,
     319,   320,   323,   324,   325,   326,   329,   330,   340,   341,
     346,   354,   365,   400,   414,   416,   421,   428,   429,   432,
     433,   434,   437,   438,   445,   446,   449,   450,   451,   454,
     455,   458,   459,   462,   463
};
#endif
...
#line 298 "NumberReader.y"
    {
                if ((yyvsp[(1) - (2)].exactValue) == 0 && foundExactness == -1) {
                  (yyval.object) = Arithmetic::inexact((yyvsp[(2) - (2)].object));
                } else {
                  (yyval.object) = ScannerHelper::applyExactness((yyvsp[(1) - (2)].exactValue), (yyvsp[(2) - (2)].object));
                }
          }
...
#line 365 "NumberReader.y"
    {
            ...
            ret = Arithmetic::mul(ret, Arithmetic::expt(Object::makeFixnum(10), Object::makeFixnum(-(yyvsp[(3) - (4)].stringValue).size())));
            foundExactness = -1; // we have DOT, so inexact
            if (!(yyvsp[(4) - (4)].stringValue).empty()) {
              ret = Arithmetic::mul(ret, Arithmetic::expt(Object::makeFixnum(10), suffixToNumber((yyvsp[(4) - (4)].stringValue))));
            }
            (yyval.object) = ret;
...
/* Line 1455 of yacc.c  */
#line 2543 "NumberReader.tab.cpp"
      default: break;
    }
