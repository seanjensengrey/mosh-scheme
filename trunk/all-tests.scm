...
(display '((equal? 'error (guard (con (#t 'error)) (let ((b #vu8(0 0 0 0 0))) (bytevector-u16-set! b 0 32768 'little) (bytevector-u16-ref b 0 'little))))))
(display ", expects ")
(display '#t)
(set! *test-ret* (equal? 'error (guard (con (#t 'error)) (let ((b #vu8(0 0 0 0 0))) (bytevector-u16-set! b 0 32768 'little) (bytevector-u16-ref b 0 'little)))))(if (equal? *test-ret* '#t) (display " ===> ok\n") (begin (set! *test-error* (cons '(equal? 'error (guard (con (#t 'error)) (let ((b #vu8(0 0 0 0 0))) (bytevector-u16-set! b 0 32768 'little) (bytevector-u16-ref b 0 'little)))) *test-error*)) (display " ===> NG got ") (write *test-ret*) (display "\n") (error "test" "test failed" '((equal? 'error (guard (con (#t 'error)) (let ((b #vu8(0 0 0 0 0))) (bytevector-u16-set! b 0 32768 'little) (bytevector-u16-ref b 0 'little))))))))(display "test ")
