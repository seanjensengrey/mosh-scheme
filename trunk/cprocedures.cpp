...
const int cProcNum = 471;
static const Object cProcs[] = {
     Object::makeCProcedure(timeUsageEx),
     Object::makeCProcedure(makeCustomTextualInputOutputPortEx),
     Object::makeCProcedure(makeCustomBinaryInputOutputPortEx),
     Object::makeCProcedure(openFileInputOutputPortEx),
     ...
     Object::makeCProcedure(putCharEx),
     ...
     Object::makeCProcedure(getDatumEx),
     Object::makeCProcedure(getLineEx),
     Object::makeCProcedure(getStringAllEx),
     Object::makeCProcedure(getStringNDEx),
     Object::makeCProcedure(getStringNEx),
     Object::makeCProcedure(lookaheadCharEx),
     Object::makeCProcedure(getCharEx),
     ...
     Object::makeCProcedure(getBytevectorAllEx),
     Object::makeCProcedure(getBytevectorSomeEx),
     Object::makeCProcedure(getBytevectorNDEx),
     ...
     Object::makeCProcedure(bytevectorU8SetDEx),
     Object::makeCProcedure(outputPortBufferModeEx),
     Object::makeCProcedure(flushOutputPortEx),
     Object::makeCProcedure(putStringEx),
     ...
     Object::makeCProcedure(peekCharEx),
