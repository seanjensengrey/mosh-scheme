...
static Object (*cProcFunctions[])(VM* vm, int, const Object*) = {
     ...
     printStackEx,
     closureTolistEx,
     instructionTointegerEx,
     instructionTosymbolEx,
     ungensymEx,
     vectorFillDEx,
     stringCopyEx,
     makePolarEx,
...
static const ucs4char* cProcNames[] = {
     ...
     UC("print-stack"),
     UC("closure->list"),
     UC("instruction->integer"),
     UC("instruction->symbol"),
     UC("ungensym"),
     UC("vector-fill!"),
     UC("string-copy"),
     UC("make-polar"),
