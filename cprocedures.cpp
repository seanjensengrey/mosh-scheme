...
const int cProcNum = 145;
static const Object cProcs[] = {
     Object::makeCProcedure(codeBuilderEmitEx),
     Object::makeCProcedure(codeBuilderAppendDEx),
     Object::makeCProcedure(codeBuilderPut5DEx),
     Object::makeCProcedure(codeBuilderPut4DEx),
     Object::makeCProcedure(codeBuilderPut3DEx),
     Object::makeCProcedure(codeBuilderPut2DEx),
     Object::makeCProcedure(codeBuilderPut1DEx),
     Object::makeCProcedure(makeCodeBuilderEx),
     Object::makeCProcedure(internalsetIntersectEx),
     Object::makeCProcedure(internalsetUnionEx),
...
static const ucs4char* cProcNames[] = {
     ...
     UC("code-builder-put5!"),
     UC("code-builder-put4!"),
     UC("code-builder-put3!"),
     UC("code-builder-put2!"),
     UC("code-builder-put1!"),
